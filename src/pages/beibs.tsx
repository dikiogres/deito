      ...
      <main>
        <section className='bg-white font-poppins'>
          <div className='layout flex min-h-screen flex-col bg-slate-900'>
            <section className='mx-auto grid h-96 w-full max-w-6xl grid-cols-3 bg-slate-900 py-16 text-left text-white'>
              <div className='flex flex-col rounded-xl bg-slate-700 px-8'>
                <Image
                  className='-mt-8'
